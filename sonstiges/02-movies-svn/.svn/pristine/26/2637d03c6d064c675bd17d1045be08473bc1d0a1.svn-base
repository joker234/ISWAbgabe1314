...
public class Customer {
	...
	public static void main(String args[])
	{
		...
		Movie film1=new Movie("Film1", 1, Language.GER, "beschreibung1", Country.GER);
		Movie film2=new Movie("Film2", 2, Language.GER, "beschreibung2", Country.GER);
		Movie film3=new Movie("Film3", 3, Language.GER, "beschreibung3", Country.GER);
		Movie film4=new Movie("Film4", 4, Language.GER, "beschreibung4", Country.GER);
		Movie film5=new Movie("Film5", 5, Language.GER, "beschreibung5", Country.GER);
		Movie film6=new Movie("Film6", 6, Language.GER, "beschreibung6", Country.GER);
		Movie film7=new Movie("Film7", 7, Language.GER, "beschreibung7", Country.GER);

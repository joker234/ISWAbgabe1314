...
public class Movie {
	 ...
	 * @param time the movie's runtime
	 */
	 ...
	 * @param title the movie's title
	 * @param time the movie's runtime
	 * @param director the director who directed the movie
	 */
	...
	public String toString(){
		return "Movie: " + this.title + " is the " + this.number + "th movie and it is " + this.time + "minutes long.";
	}
	...
	public static void main(String args[]) {
		...
		final String s1=mymovie.getTitle() + ": Länge " + mymovie.getTime() + ", Seriennummer " + mymovie.getNumber();
		System.out.println(s1);
		final String s2=myothermovie.getTitle() + ": Länge " + myothermovie.getTime() + ", Seriennummer " + myothermovie.getNumber();
